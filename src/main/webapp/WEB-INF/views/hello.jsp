        ...
        $.ajax({
            ...
            success: function (result) {
                for (var i = 0; i < result.length; i++) {
                    ...
                    var content = '<div class="image"><img src="/img/marker/marker.png"><div id="text">' + result[i].parkingBikeTotCnt + '</div></div>';
                    // 커스텀 오버레이가 표시될 위치입니다 
                    ...
                    //     map: map, // 마커를 표시할 지도
                    //     position: new kakao.maps.LatLng(result[i].stationLatitude, result[i].stationLongitude),
                    ...
                    //     position: new kakao.maps.LatLng(result[i].stationLatitude, result[i].stationLongitude),
                    //     content: '<div style="padding:5px;" ><h3 style="text-align:center; ">' + name +
                    //         '</h3><h3>대여가능: ' + result[i].parkingBikeTotCnt + '</h3></div>',
                    //     removable: false
                    // });
                }
        ...
        <div class="row">
          <div class="col-12 ">
            <div class="card card-chart">
              <div class="card-body">
                <div id="map" class="chart-area" style="height: 800px;">
